...
void draw_arrow(uint8_t *ssd, int x, int y) {
    // Corpo da seta (linha horizontal)
    ssd1306_draw_line(ssd, x, y, x + 10, y, true);
    
    // Ponta da seta (duas linhas diagonais)
    ssd1306_draw_line(ssd, x + 10, y, x + 6, y - 3, true);
    ssd1306_draw_line(ssd, x + 10, y, x + 6, y + 3, true);
}
